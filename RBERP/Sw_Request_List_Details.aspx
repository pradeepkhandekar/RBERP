<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sw_Request_List_Details.aspx.cs" Inherits="RBERP.Sw_Request_List_Details" %>
            ...
            <tr>
                <td align="center" colspan="4">
                    <asp:Label ID="Label1" runat="server" style="color: #0099FF; font-weight: 700; font-size: x-large;" 
                        Text="
List Of Request Details"></asp:Label>
                    </td>
            </tr>
            <tr>
                    ...
                    <asp:GridView ID="GridView1" runat="server"
                        ...
                        <Columns>
                            ...
                            <ItemStyle HorizontalAlign="Center" />
                             ...
                             <asp:HyperLinkField DataNavigateUrlFields="Request_ID" DataNavigateUrlFormatString="Sw_Request_Assigin_To_Developer.aspx?Request_ID={0}" 
                                   DataTextField="Request_ID" HeaderText="Assign To Developer" Target="_blank" DataTextFormatString="Assign">
                            <ItemStyle HorizontalAlign="Center" />
                            </asp:HyperLinkField>
