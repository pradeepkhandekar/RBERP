<%@ Page Language="C#" AutoEventWireup="true" Inherits="Lead_Status_Master" CodeBehind="Lead_Status_Master.aspx.cs" %>
...
<body>
    ...
    <div>
        ...
        <table class="auto-style1" style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-size: 10pt">
            <tr>
                <td align="center"colspan="3" class="auto-style2"><strong>Lead Status Master</strong></td>
            </tr>
            <tr>
            ...
            <tr>
                <td  align="right" class="auto-style5">Lead Status</td>
                <td>:</td>
                <td>
                    <asp:TextBox ID="txtleadstatus" runat="server" Width="240px" TabIndex="1"></asp:TextBox>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <asp:Button ID="btnsubmit" runat="server" OnClick="btnsubmit_Click" Text="Submit" />
                    <asp:Button ID="btnsubmit0" runat="server" OnClick="btnsubmit0_Click" Text="Reset" />
                </td>
            </tr>
            <tr>
                <td align="center"colspan="3" class="auto-style3">
                    l<asp:GridView ID="dgleadstatuslist" runat="server" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" AutoGenerateColumns="False" Height="121px" Width="711px">
                        <Columns>
                            <asp:BoundField DataField="Lead_Status_Id" HeaderText="Lead Status Id">
